...
import { colors, textColors, borderColors, cards, roomSelection, roomSetup, game, professionSelection, dreamSelection } from './colors';

// Реэкспортируем цвета для удобства использования
export { colors, textColors, borderColors, cards, roomSelection, roomSetup, game, professionSelection, dreamSelection };
...
export const cardStyles = {
  ...
  // Карточка игрока
  player: {
    bgcolor: cards.player,
    border: `2px solid ${cards.player}`,
    borderRadius: 2,
...
export const containerStyles = {
  ...
  pageContainer: {
    minHeight: '100vh',
    background: roomSelection.background,
    display: 'flex',
